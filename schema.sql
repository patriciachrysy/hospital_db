...
CREATE INDEX idx_medical_histories ON medical_histories_treatment (medical_history_id);

CREATE INDEX idx_treatments ON medical_histories_treatment (treatment_id);